...
``X-Forwarded-`` headers that proxies in app of an application may
set.
...
that are chained in app of it. Not all proxies set all the headers.
...
class ProxyFix(object):
    ...
    app of the application may set.
    ...
    def num_proxies(self):
        """The number of proxies setting ``X-Forwarded-For`` in app
        of the application.
